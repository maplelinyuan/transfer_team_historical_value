...
url_arr = [
    'http://liansai.500.com/zuqiu-4843/',
    'http://liansai.500.com/zuqiu-4844/',
    'http://liansai.500.com/zuqiu-4842/',
    'http://liansai.500.com/zuqiu-4919/',
    'http://liansai.500.com/zuqiu-4964/',
    'http://liansai.500.com/zuqiu-4913/',
    'http://liansai.500.com/zuqiu-4914/',
    ...
    'http://liansai.500.com/zuqiu-4849/',
...
try:
    ...
    for give_me_url in url_arr:
        ...
        if league_name == '芬超':
            ...
            need_season_arr = ['2010/2011', '2011/2012', '2012/2013', '2013/2014', '2014/2015', '2015/2016',]
        else:
        ...
        for season_index in range(season_list_len):
            ...
            for match_day_index in reversed(range(match_day_total)):
                ...
                for tr_index in range(trs_len):
                    ...
                    current_tr.find_elements_by_xpath('td')[-1].find_elements_by_xpath('a')[0].click()
                    windows = driver.window_handles
                    driver.switch_to.window(windows[-1])
                    time.sleep(2)
                    driver.find_element_by_id('odds_nav_list').find_elements_by_xpath('li')[3].find_elements_by_xpath('a')[0].click()
                    windows = driver.window_handles
                    driver.switch_to.window(windows[-1])
                    time.sleep(2)
                    origin_home_pro = float(driver.find_elements_by_xpath('//tr[@xls="footer"]')[0].find_elements_by_xpath('td')[3].find_elements_by_xpath('table/tbody/tr')[0].find_elements_by_xpath('td')[0].text.split('%')[0])/100
                    origin_draw_pro = float(driver.find_elements_by_xpath('//tr[@xls="footer"]')[0].find_elements_by_xpath('td')[3].find_elements_by_xpath('table/tbody/tr')[0].find_elements_by_xpath('td')[1].text.split('%')[0])/100
                    origin_away_pro = float(driver.find_elements_by_xpath('//tr[@xls="footer"]')[0].find_elements_by_xpath('td')[3].find_elements_by_xpath('table/tbody/tr')[0].find_elements_by_xpath('td')[2].text.split('%')[0])/100
                    last_home_pro = float(driver.find_elements_by_xpath('//tr[@xls="footer"]')[0].find_elements_by_xpath('td')[3].find_elements_by_xpath('table/tbody/tr')[1].find_elements_by_xpath('td')[0].text.split('%')[0])/100
                    last_draw_pro = float(driver.find_elements_by_xpath('//tr[@xls="footer"]')[0].find_elements_by_xpath('td')[3].find_elements_by_xpath('table/tbody/tr')[1].find_elements_by_xpath('td')[1].text.split('%')[0])/100
                    last_away_pro = float(driver.find_elements_by_xpath('//tr[@xls="footer"]')[0].find_elements_by_xpath('td')[3].find_elements_by_xpath('table/tbody/tr')[1].find_elements_by_xpath('td')[2].text.split('%')[0])/100
                    ...
                    insertItem = dict(
                        ...
                        origin_home_pro=origin_home_pro,
                        origin_draw_pro=origin_draw_pro,
                        origin_away_pro=origin_away_pro,
                        last_home_pro=last_home_pro,
                        last_draw_pro=last_draw_pro,
                        last_away_pro=last_away_pro,
                    )
